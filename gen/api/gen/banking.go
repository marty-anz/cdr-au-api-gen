...
// BankingProductRateTierV3UnitOfMeasure The unit of measure that applies to the minimumValue and maximumValue values e.g. a **DOLLAR** amount. **PERCENT** (in the case of loan-to-value ratio or LVR). Tier term period representing a discrete number of **MONTH**'s or **DAY**'s (in the case of term deposit tiers)
...
type MetaPaginatedTransaction struct {
	// IsQueryParamUnsupported **true** if *"text"* query parameter is not supported
...
type ClientInterface interface {
	...
	// ListBalancesSpecificAccountsWithBody request with any body
	...
	// ListDirectDebitsSpecificAccountsWithBody request with any body
	...
	// ListScheduledPaymentsSpecificAccountsWithBody request with any body
...
type ClientWithResponsesInterface interface {
	...
	// ListBalancesSpecificAccountsWithBodyWithResponse request with any body
	...
	// ListDirectDebitsBulkWithResponse request
	...
	// ListDirectDebitsSpecificAccountsWithBodyWithResponse request with any body
	...
	// GetAccountDetailWithResponse request
	...
	// ListDirectDebitsWithResponse request
	...
	// GetTransactionDetailWithResponse request
	...
	// ListScheduledPaymentsBulkWithResponse request
	...
	// ListScheduledPaymentsSpecificAccountsWithBodyWithResponse request with any body
	...
	// GetProductDetailWithResponse request
...
type ListScheduledPaymentsResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *ResponseBankingScheduledPaymentsListV2
	JSON400      *ResponseErrorListV2
	JSON404      *ResponseErrorListV2
	JSON406      *ResponseErrorListV2
	JSON422      *ResponseErrorListV2
...
func ParseListScheduledPaymentsResponse(rsp *http.Response) (*ListScheduledPaymentsResponse, error) {
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest ResponseBankingScheduledPaymentsListV2
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
...
type ServerInterface interface {
	...
	ListBalancesBulk(w http.ResponseWriter, r *http.Request, params ListBalancesBulkParams)
	// Get Balances For Specific Accounts
	// (POST /banking/accounts/balances)
	ListBalancesSpecificAccounts(w http.ResponseWriter, r *http.Request, params ListBalancesSpecificAccountsParams)
	// Get Bulk Direct Debits
	// (GET /banking/accounts/direct-debits)
	ListDirectDebitsBulk(w http.ResponseWriter, r *http.Request, params ListDirectDebitsBulkParams)
	// Get Direct Debits For Specific Accounts
	// (POST /banking/accounts/direct-debits)
	ListDirectDebitsSpecificAccounts(w http.ResponseWriter, r *http.Request, params ListDirectDebitsSpecificAccountsParams)
	// Get Account Detail
	// (GET /banking/accounts/{accountId})
	GetAccountDetail(w http.ResponseWriter, r *http.Request, accountId string, params GetAccountDetailParams)
	// Get Account Balance
	// (GET /banking/accounts/{accountId}/balance)
	GetBalance(w http.ResponseWriter, r *http.Request, accountId string, params GetBalanceParams)
	// Get Direct Debits For Account
	// (GET /banking/accounts/{accountId}/direct-debits)
	ListDirectDebits(w http.ResponseWriter, r *http.Request, accountId string, params ListDirectDebitsParams)
	// Get Scheduled Payments for Account
	// (GET /banking/accounts/{accountId}/payments/scheduled)
	ListScheduledPayments(w http.ResponseWriter, r *http.Request, accountId string, params ListScheduledPaymentsParams)
	// Get Transactions For Account
	// (GET /banking/accounts/{accountId}/transactions)
	GetTransactions(w http.ResponseWriter, r *http.Request, accountId string, params GetTransactionsParams)
	// Get Transaction Detail
	// (GET /banking/accounts/{accountId}/transactions/{transactionId})
	GetTransactionDetail(w http.ResponseWriter, r *http.Request, accountId string, transactionId string, params GetTransactionDetailParams)
	// Get Payees
	// (GET /banking/payees)
	ListPayees(w http.ResponseWriter, r *http.Request, params ListPayeesParams)
	// Get Payee Detail
	// (GET /banking/payees/{payeeId})
	GetPayeeDetail(w http.ResponseWriter, r *http.Request, payeeId string, params GetPayeeDetailParams)
	// Get Scheduled Payments Bulk
	// (GET /banking/payments/scheduled)
	ListScheduledPaymentsBulk(w http.ResponseWriter, r *http.Request, params ListScheduledPaymentsBulkParams)
	// Get Scheduled Payments For Specific Accounts
	// (POST /banking/payments/scheduled)
	ListScheduledPaymentsSpecificAccounts(w http.ResponseWriter, r *http.Request, params ListScheduledPaymentsSpecificAccountsParams)
	// Get Products
	// (GET /banking/products)
	ListProducts(w http.ResponseWriter, r *http.Request, params ListProductsParams)
	// Get Product Detail
	// (GET /banking/products/{productId})
	GetProductDetail(w http.ResponseWriter, r *http.Request, productId string, params GetProductDetailParams)
}
...
// Get Bulk Balances
// (GET /banking/accounts/balances)
func (_ Unimplemented) ListBalancesBulk(w http.ResponseWriter, r *http.Request, params ListBalancesBulkParams) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Get Balances For Specific Accounts
// (POST /banking/accounts/balances)
func (_ Unimplemented) ListBalancesSpecificAccounts(w http.ResponseWriter, r *http.Request, params ListBalancesSpecificAccountsParams) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Get Bulk Direct Debits
// (GET /banking/accounts/direct-debits)
func (_ Unimplemented) ListDirectDebitsBulk(w http.ResponseWriter, r *http.Request, params ListDirectDebitsBulkParams) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Get Direct Debits For Specific Accounts
// (POST /banking/accounts/direct-debits)
func (_ Unimplemented) ListDirectDebitsSpecificAccounts(w http.ResponseWriter, r *http.Request, params ListDirectDebitsSpecificAccountsParams) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Get Account Detail
// (GET /banking/accounts/{accountId})
func (_ Unimplemented) GetAccountDetail(w http.ResponseWriter, r *http.Request, accountId string, params GetAccountDetailParams) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Get Account Balance
// (GET /banking/accounts/{accountId}/balance)
func (_ Unimplemented) GetBalance(w http.ResponseWriter, r *http.Request, accountId string, params GetBalanceParams) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Get Direct Debits For Account
// (GET /banking/accounts/{accountId}/direct-debits)
func (_ Unimplemented) ListDirectDebits(w http.ResponseWriter, r *http.Request, accountId string, params ListDirectDebitsParams) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Get Scheduled Payments for Account
// (GET /banking/accounts/{accountId}/payments/scheduled)
func (_ Unimplemented) ListScheduledPayments(w http.ResponseWriter, r *http.Request, accountId string, params ListScheduledPaymentsParams) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Get Transactions For Account
// (GET /banking/accounts/{accountId}/transactions)
func (_ Unimplemented) GetTransactions(w http.ResponseWriter, r *http.Request, accountId string, params GetTransactionsParams) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Get Transaction Detail
// (GET /banking/accounts/{accountId}/transactions/{transactionId})
func (_ Unimplemented) GetTransactionDetail(w http.ResponseWriter, r *http.Request, accountId string, transactionId string, params GetTransactionDetailParams) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// Get Payee Detail
// (GET /banking/payees/{payeeId})
func (_ Unimplemented) GetPayeeDetail(w http.ResponseWriter, r *http.Request, payeeId string, params GetPayeeDetailParams) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Get Scheduled Payments Bulk
// (GET /banking/payments/scheduled)
func (_ Unimplemented) ListScheduledPaymentsBulk(w http.ResponseWriter, r *http.Request, params ListScheduledPaymentsBulkParams) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Get Scheduled Payments For Specific Accounts
// (POST /banking/payments/scheduled)
func (_ Unimplemented) ListScheduledPaymentsSpecificAccounts(w http.ResponseWriter, r *http.Request, params ListScheduledPaymentsSpecificAccountsParams) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// Get Product Detail
// (GET /banking/products/{productId})
func (_ Unimplemented) GetProductDetail(w http.ResponseWriter, r *http.Request, productId string, params GetProductDetailParams) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
func (siw *ServerInterfaceWrapper) ListAccounts(w http.ResponseWriter, r *http.Request) {
	...
	// ------------- Optional query parameter "product-category" -------------

	err = runtime.BindQueryParameter("form", true, false, "product-category", r.URL.Query(), &params.ProductCategory)
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "product-category", Err: err})
		return
	}

	// ------------- Optional query parameter "open-status" -------------

	err = runtime.BindQueryParameter("form", true, false, "open-status", r.URL.Query(), &params.OpenStatus)
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "open-status", Err: err})
		return
	}

	// ------------- Optional query parameter "is-owned" -------------

	err = runtime.BindQueryParameter("form", true, false, "is-owned", r.URL.Query(), &params.IsOwned)
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "is-owned", Err: err})
		return
	}
...
// ListBalancesBulk operation middleware
func (siw *ServerInterfaceWrapper) ListBalancesBulk(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params ListBalancesBulkParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ListBalancesBulk(w, r, params)
	}))
...
// ListBalancesSpecificAccounts operation middleware
func (siw *ServerInterfaceWrapper) ListBalancesSpecificAccounts(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params ListBalancesSpecificAccountsParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ListBalancesSpecificAccounts(w, r, params)
	}))
...
// ListDirectDebitsBulk operation middleware
func (siw *ServerInterfaceWrapper) ListDirectDebitsBulk(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params ListDirectDebitsBulkParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ListDirectDebitsBulk(w, r, params)
	}))
...
// ListDirectDebitsSpecificAccounts operation middleware
func (siw *ServerInterfaceWrapper) ListDirectDebitsSpecificAccounts(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params ListDirectDebitsSpecificAccountsParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ListDirectDebitsSpecificAccounts(w, r, params)
	}))
...
// GetAccountDetail operation middleware
func (siw *ServerInterfaceWrapper) GetAccountDetail(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	// Parameter object where we will unmarshal all parameters from the context
	var params GetAccountDetailParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetAccountDetail(w, r, accountId, params)
	}))
...
func (siw *ServerInterfaceWrapper) GetBalance(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetBalance(w, r, accountId, params)
	}))
...
// ListDirectDebits operation middleware
func (siw *ServerInterfaceWrapper) ListDirectDebits(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	// Parameter object where we will unmarshal all parameters from the context
	var params ListDirectDebitsParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ListDirectDebits(w, r, accountId, params)
	}))
...
// ListScheduledPayments operation middleware
func (siw *ServerInterfaceWrapper) ListScheduledPayments(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	// Parameter object where we will unmarshal all parameters from the context
	var params ListScheduledPaymentsParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ListScheduledPayments(w, r, accountId, params)
	}))
...
func (siw *ServerInterfaceWrapper) GetTransactions(w http.ResponseWriter, r *http.Request) {
	...
	// ------------- Optional query parameter "oldest-time" -------------

	err = runtime.BindQueryParameter("form", true, false, "oldest-time", r.URL.Query(), &params.OldestTime)
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "oldest-time", Err: err})
		return
	}

	// ------------- Optional query parameter "newest-time" -------------

	err = runtime.BindQueryParameter("form", true, false, "newest-time", r.URL.Query(), &params.NewestTime)
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "newest-time", Err: err})
		return
	}

	// ------------- Optional query parameter "min-amount" -------------

	err = runtime.BindQueryParameter("form", true, false, "min-amount", r.URL.Query(), &params.MinAmount)
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "min-amount", Err: err})
		return
	}

	// ------------- Optional query parameter "max-amount" -------------

	err = runtime.BindQueryParameter("form", true, false, "max-amount", r.URL.Query(), &params.MaxAmount)
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "max-amount", Err: err})
		return
	}
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetTransactions(w, r, accountId, params)
	}))
...
// GetTransactionDetail operation middleware
func (siw *ServerInterfaceWrapper) GetTransactionDetail(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetTransactionDetail(w, r, accountId, transactionId, params)
	}))
...
// GetPayeeDetail operation middleware
func (siw *ServerInterfaceWrapper) GetPayeeDetail(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	err = runtime.BindStyledParameterWithOptions("simple", "payeeId", chi.URLParam(r, "payeeId"), &payeeId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "payeeId", Err: err})
		return
	}

	// Parameter object where we will unmarshal all parameters from the context
	var params GetPayeeDetailParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetPayeeDetail(w, r, payeeId, params)
	}))
...
// ListScheduledPaymentsBulk operation middleware
func (siw *ServerInterfaceWrapper) ListScheduledPaymentsBulk(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params ListScheduledPaymentsBulkParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ListScheduledPaymentsBulk(w, r, params)
	}))
...
// ListScheduledPaymentsSpecificAccounts operation middleware
func (siw *ServerInterfaceWrapper) ListScheduledPaymentsSpecificAccounts(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params ListScheduledPaymentsSpecificAccountsParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ListScheduledPaymentsSpecificAccounts(w, r, params)
	}))
...
func (siw *ServerInterfaceWrapper) ListProducts(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindQueryParameter("form", true, false, "updated-since", r.URL.Query(), &params.UpdatedSince)
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "updated-since", Err: err})
		return
	}
...
func (siw *ServerInterfaceWrapper) GetProductDetail(w http.ResponseWriter, r *http.Request) {
	...
	// Parameter object where we will unmarshal all parameters from the context
	var params GetProductDetailParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetProductDetail(w, r, productId, params)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/banking/accounts", wrapper.ListAccounts)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/banking/accounts/balances", wrapper.ListBalancesBulk)
	})
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/banking/accounts/balances", wrapper.ListBalancesSpecificAccounts)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/banking/accounts/direct-debits", wrapper.ListDirectDebitsBulk)
	})
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/banking/accounts/direct-debits", wrapper.ListDirectDebitsSpecificAccounts)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/banking/accounts/{accountId}", wrapper.GetAccountDetail)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/banking/accounts/{accountId}/balance", wrapper.GetBalance)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/banking/accounts/{accountId}/direct-debits", wrapper.ListDirectDebits)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/banking/accounts/{accountId}/payments/scheduled", wrapper.ListScheduledPayments)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/banking/accounts/{accountId}/transactions", wrapper.GetTransactions)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/banking/accounts/{accountId}/transactions/{transactionId}", wrapper.GetTransactionDetail)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/banking/payees", wrapper.ListPayees)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/banking/payees/{payeeId}", wrapper.GetPayeeDetail)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/banking/payments/scheduled", wrapper.ListScheduledPaymentsBulk)
	})
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/banking/payments/scheduled", wrapper.ListScheduledPaymentsSpecificAccounts)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/banking/products", wrapper.ListProducts)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/banking/products/{productId}", wrapper.GetProductDetail)
	})
